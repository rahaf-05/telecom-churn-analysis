...
Data cleaned by converting `TotalCharges` to numeric and dropping resulting missing rows (11 rows removed). Findings validated with SQL and visualized in Power BI. Dataset: [IBM Telco Customer Churn](https://www.kaggle.com/datasets/blastchar/telco-customer-churn?resource=download) (Kaggle).
